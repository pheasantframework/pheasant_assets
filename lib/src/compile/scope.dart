...
''';
  ...
  try { 
    scopedCssData = sass.compileStringToResult(
      scopableCssData,
    ...
    throw PheasantStyleException('Error while scoping css data: ${exception.message}');
  } catch (genExc, stackTrace) {
    throw PheasantStyleException('Error while scoping css data. \nError Type: $genExc \nStack Trace: $stackTrace');
  }
